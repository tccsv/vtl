...
#define CONFIGURE_ARGS " '--prefix=/pg-install' '--without-readline' '--without-zlib' '--without-icu' '--without-gssapi' '--without-ldap' '--without-llvm' '--without-pam' '--without-systemd' '--without-bonjour' '--without-selinux' '--without-libxml' '--without-libxslt' '--without-perl' '--without-python' '--without-tcl' '--with-openssl' '--with-includes=/openssl/include' '--with-libraries=/openssl/lib' 'CFLAGS=-O2 -fPIC'"
...
#define PG_VERSION_STR "PostgreSQL 18.3 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14+deb12u1) 12.2.0, 64-bit"
