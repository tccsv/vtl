...
static const char *platform_str(int platform)
{
    switch (platform)
    {
    case VTL_PLATFORM_TELEGRAM:
        return "TG";
    case VTL_PLATFORM_VK:
        return "VK";
    default:
        return "??";
    }
...
static const char *status_str(int status)
{
    switch (status)
    {
    case VTL_PUBLICATION_DRAFT:
        return "Draft";
    case VTL_PUBLICATION_SCHEDULED:
        return "Scheduled";
    case VTL_PUBLICATION_PUBLISHED:
        return "Published";
    case VTL_PUBLICATION_FAILED:
        return "Failed";
    default:
        return "Unknown";
    }
...
static VTL_AppResult execute_and_print_params(VTL_Database *db,
                                              const char *sql,
                                              int param_count,
                                              ...
                                              const char *title)
{
    PGresult *res = PQexecParams(db->conn, sql, param_count, param_types,
