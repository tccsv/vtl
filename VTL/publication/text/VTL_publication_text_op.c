...
static VTL_AppResult VTL_publication_text_InitFromRegular(VTL_publication_MarkedText** pp_publication, 
                                                const VTL_publication_Text* p_src_text)
{
    return VTL_res_kOk;
}
                                                ...
                                                const VTL_publication_marked_text_MarkupType src_markup_type)
{
    ...
    if(src_markup_type == VTL_markup_type_kRegular)
    {
        return VTL_publication_text_InitFromRegular(pp_marked_text, p_src_text);
    }
    return VTL_res_kOk;
}
