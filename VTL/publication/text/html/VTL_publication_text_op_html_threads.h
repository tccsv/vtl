#ifndef _VTL_PUBLICATION_TEXT_OP_HTML_THREADS_H
#define _VTL_PUBLICATION_TEXT_OP_HTML_THREADS_H
...
// Никаких внешних зависимостей. Локально для html-модуля.
...
typedef HANDLE vtl_html_thread_t;
...
static inline int vtl_html_thread_create(vtl_html_thread_t* t, void* (*fn)(void*), void* arg)
{
    *t = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)(void*)fn, arg, 0, NULL);
    return (*t == NULL) ? -1 : 0;
}

static inline void* vtl_html_thread_join(vtl_html_thread_t t)
{
...
static inline double vtl_html_monotonic_seconds(void)
{
...
typedef pthread_t vtl_html_thread_t;
